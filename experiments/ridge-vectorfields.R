...
# pdf("u1.pdf", width = 7, height = 7, bg = "transparent")
png("u1.png", width = 7, height = 7, bg = "transparent", units = "in", res = 200)
...
# pdf("u2.pdf", width = 7, height = 7, bg = "transparent")
png("u2.png", width = 7, height = 7, bg = "transparent", units = "in", res = 200)
ks::plotmixt(mus = mu, Sigmas = Sigma, props = 1, display = "filled.contour2",
             gridsize = rep(251, 2), xlim = c(-4, 4), ylim = c(-4, 4),
             cont = seq(0, 95, by = 5), col.fun = viridis::viridis,
             binned = FALSE, xlab = "", ylab = "")
...
# pdf("Df.pdf", width = 7, height = 7, bg = "transparent")
png("Df.png", width = 7, height = 7, bg = "transparent", units = "in", res = 200)
ks::plotmixt(mus = mu, Sigmas = Sigma, props = 1, display = "filled.contour2",
             gridsize = rep(251, 2), xlim = c(-4, 4), ylim = c(-4, 4),
             cont = seq(0, 95, by = 5), col.fun = viridis::viridis,
             binned = FALSE, xlab = "", ylab = "")
...
# pdf("Dfp.pdf", width = 7, height = 7, bg = "transparent")
png("Dfp.png", width = 7, height = 7, bg = "transparent", units = "in", res = 200)
ks::plotmixt(mus = mu, Sigmas = Sigma, props = 1, display = "filled.contour2",
             gridsize = rep(251, 2), xlim = c(-4, 4), ylim = c(-4, 4),
             cont = seq(0, 95, by = 5), col.fun = viridis::viridis,
             binned = FALSE, xlab = "", ylab = "")
