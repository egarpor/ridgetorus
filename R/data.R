...
#' in radians in \eqn{\mathbb{T}=[-\pi, \pi)} with \eqn{-\pi} /
#' \eqn{-\frac{\pi}{2}} / \eqn{0} / \eqn{\frac{\pi}{2}} / \eqn{\pi} representing
#' the East / South / West / North / East directions. The script performing the
#' data preprocessing is available at
